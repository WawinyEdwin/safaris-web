    ...
    <div class="col-lg-3 col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('addtour.create') }}" class="btn btn-primar"> <i class="bi bi-bag-plus"></i></a>
            </div>
        </div> 
    </div>
    <div class="col-lg-3 col-sm-12">
    <div class="card">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-bag"></i> Products</h5>
                    ...
                    <a href="{{ route('products.create') }}" class="btn btn-primar"><i class="bi bi-bag-plus"></i> </a>
            </div>
        </div> 
    </div>
    <div class="col-lg-3 col-sm-12">
    ...
    <div class="card">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-database"></i> Services</h5>
                    ...
                    <a href="{{ route('services.create') }}" class="btn btn-primar"><i class="bi bi-bag-plus"></i> </a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-3 col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('blogs.create') }}" class="btn btn-primar"><i class="bi bi-bag-plus"></i> </a>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-sm-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-check-square"></i> Highlights</h5>
                    ...
                    <a href="{{ route('highlights.create') }}" class="btn btn-primar"><i class="bi bi-bag-plus"></i> </a>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-sm-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-file-earmark-play"></i> Videos</h5>
                    ...
                    <a href="{{ route('videos.create') }}" class="btn btn-primar"><i class="bi bi-bag-plus"></i> </a>
</div>
        </div>
    </div>
</div>
...
<div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('category.create') }}" class="btn btn-primar"><i class="bi bi-bag-plus"></i></a>
    ...
    <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('events.all') }}" class="btn btn-primar">all events</a>
                    <a href="{{ route('events.create') }}" class="btn btn-primar"><i class="bi bi-bag-plus"></i> </a>
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
    <div class="card">
            <div class="card-body">
                ...
                <a href="#" class="btn btn-primar">Users.</a>
            </div>
        </div>
    </div>
