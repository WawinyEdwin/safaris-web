...
<div class="container">
    ...
    <form action="{{ route('blogs.store') }}" method="post" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <textarea name="content" id="summernote" cols="30" rows="10" class="form-control  @error('content') is-invalid @enderror" required></textarea>
            @error('content')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
        ...
        <div class="form-group">
            ...
            <input type="file" name="image2" id="image2" class="form-control-file @error('image2') is-invalid @enderror" >
            @error('image2')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
        ...
        <div class="form-group">
            ...
            <input type="file" name="image3" id="image3" class="form-control-file @error('image3') is-invalid @enderror">
            @error('image3')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <input type="file" name="image4" id="image4" class="form-control-file @error('image4') is-invalid @enderror" >
            @error('image4')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
        ...
        <div class="form-group">
            ...
            <input type="file" name="image5" id="image5" class="form-control-file @error('image5') is-invalid @enderror">
            @error('image5')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <input type="file" name="image6" id="image6" class="form-control-file @error('image6') is-invalid @enderror" >
            @error('image6')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
